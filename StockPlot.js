...
import './App.css';import '../node_modules/react-vis/dist/style.css';
import {XYPlot, LineSeries, XAxis, YAxis, HorizontalGridLines, MarkSeries} from 'react-vis';
import { getStockWithCode, getFakeNewsForCompany } from "./StockAPI";
    ...
    render() {
        ...
        return <div>
            <XYPlot height={500} width={1000} >
                ...
                <MarkSeries data={fakeNews} color="#00DFC2" stroke={"#fff"} sizeRange={[5, 12]} strokeWidth={4}/>
